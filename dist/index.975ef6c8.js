...
const model = [
    new (0, _blocks.TitleBlock)("Hello world!!!", {
        tag: "h2",
        styles: {
...
class ImageBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)(`<img src="${this.value}" style ="${(0, _utils.css)(is)}" alt='${alt}'>`, (0, _utils.css)(this.options.styles));
    }
}
class ColumnsBlock extends Block {
    ...
    toHTML() {
        const html = this.value.map((item)=>(0, _utils.col)(item));
...
function col(conntet) {
    return `<div class='col-sm'>${conntet}</div>`;
}
function css(styles = {}) {
...
class Sidebar {
    ...
    add(event) {
        ...
        const newBlock = type === "type" ? new (0, _blocks.TextBlock)(value, {
            styles: styles
...
},{"../utils":"en4he","./blocks":"gMfMj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"clPKd":[function() {},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequiree799")
